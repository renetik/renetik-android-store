...
): CSStoreProperty<String> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Float,
    onApply: ((value: Float) -> Unit)? = null
): CSStoreProperty<Float> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Long,
    onApply: ((value: Long) -> Unit)? = null
): CSStoreProperty<Long> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Int,
    onApply: ((value: Int) -> Unit)? = null
): CSStoreProperty<Int> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Boolean,
    onChange: ((value: Boolean) -> Unit)? = null
): CSStoreProperty<Boolean> = store.property(key, default, onChange)

fun <T> Context.property(
    key: String, values: List<T>, default: T,
    onApply: ((value: T) -> Unit)? = null
): CSStoreProperty<T> = store.property(key, values, default, onApply)

fun <T> Context.property(
    key: String, values: List<T>, defaultIndex: Int,
    onApply: ((value: T) -> Unit)? = null
): CSStoreProperty<T> = property(key, values, values[defaultIndex], onApply)
...
fun <T> Context.property(
    ...
    onApply: ((value: T) -> Unit)? = null
): CSStoreProperty<T> = store.property(key, values, defaultIndex, onApply)