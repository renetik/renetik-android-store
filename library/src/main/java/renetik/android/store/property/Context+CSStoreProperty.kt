...
): CSEventProperty<String> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Float,
    onApply: ((value: Float) -> Unit)? = null
): CSEventProperty<Float> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Long,
    onApply: ((value: Long) -> Unit)? = null
): CSEventProperty<Long> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Int,
    onApply: ((value: Int) -> Unit)? = null
): CSEventProperty<Int> = store.property(key, default, onApply)

fun Context.property(
    key: String, default: Boolean,
    onChange: ((value: Boolean) -> Unit)? = null
): CSEventProperty<Boolean> = store.property(key, default, onChange)
